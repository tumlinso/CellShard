...
using annotation_column = observation_metadata_column;

struct annotation_summary {
...
struct dataset_summary {
    ...
    annotation_summary observation_annotations;
    annotation_summary feature_annotations;
...
struct anndata_export {
    ...
    std::vector<annotation_column> var_columns;
    std::vector<dataset_attribute> uns;
    csr_matrix_export x;
};
...
bool load_dataset_attributes(const char *path,
                             std::vector<dataset_attribute> *out,
                             std::string *error = nullptr);
