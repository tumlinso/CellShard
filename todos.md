...
- `CS-FOUND-06` | kind: task | status: in_progress | parent: CS-FOUND-00 | objective: Separate immutable storage objects/extents from mutable source locations and define the non-owning storage-independent exact-read boundary as CS-FOUND-I2C.
