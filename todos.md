...
- `CS-FOUND-05` | kind: task | status: in_progress | parent: CS-FOUND-00 | objective: Represent producer-owned opaque execution images through producer ABI, target, projection, reuse, owning descriptor, and allocation-free view as CS-FOUND-I2B.
