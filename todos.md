...
- `CS-FOUND-08` | kind: task | status: in_progress | parent: CS-FOUND-00 | objective: Implement deterministic explicit little-endian CPEXEC02 buffer encoding/decoding as CS-FOUND-I3B without CSPACK file integration.
