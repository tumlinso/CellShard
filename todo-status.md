...
- `CS-FOUND-08` | status: in_progress | execution: claimed | next: Implement fixed-field/table codec, deterministic padding/checksum, size calculation, and malformed-buffer tests only.
