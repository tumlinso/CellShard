...
static inline int build_coo_from_compressed_library_raw(
    const unsigned int cDim,
    const unsigned int nnz,
...
static inline int build_coo_from_compressed_custom_raw(
    const unsigned int cDim,
    const unsigned int nnz,
    const unsigned int *d_cAxPtr,
    const unsigned int *d_uAxIdx,
...
static inline int build_coo_from_compressed_raw(
    ...
    if (build_coo_from_compressed_custom_raw(
            cDim,
            nnz,
            d_cAxPtr,
            d_uAxIdx,
    ...
    return build_coo_from_compressed_library_raw(
        cDim,
        nnz,
        d_cAxPtr,
        d_uAxIdx,
