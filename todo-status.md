...
- `CS-FOUND-06` | status: in_progress | execution: claimed | next: Implement I2C and fake in-memory exact-range source; defer local files unless mechanically inseparable.
