...
- `CS-FOUND-07` | status: in_progress | execution: claimed | next: Review I1/I2A/I2B/I2C, reach C1 and G2, then implement catalog/snapshot validation without persistent manifest format.
